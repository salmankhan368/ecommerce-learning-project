...
import 'package:s_store/fetaures/shop/screens/product_detail/widgets/sbottom.add.to.cart.dart';
import 'package:s_store/fetaures/shop/screens/product_reviews/product_reviews.dart';
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SSectionHeading(title: 'Reviews(199)', showBackAction: false),
                  IconButton(
